{\chapter{El modelo de Leslie-Gower con respuesta funcional sigmoidea}
    ...
    \begin{remark}
	    	...
	    	\begin{equation}
	    		...
	    		\end{bmatrix},
	    	\end{equation}
	    	tiene determinante $nK^{2} \dfrac{u\left(u^{2}+\left(\dfrac{a}{K}\right)^{2}\right)}{r} > 0$, por lo que la transformación $\varphi$ preserva la orientación por tiempo. Además, como por definición todo difeomorfismo es un homeomorfismo, el sistema \eqref{eq: modelo1} es topológicamente equivalente al sistema \eqref{eq: modelo2}.
    \end{remark}