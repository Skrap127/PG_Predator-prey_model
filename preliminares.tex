...
Como ejemplos representativos de modelos ecológicos, se pueden mencionar los modelos de Lotka-Volterra, May-Holling-Turner y Leslie-Gower, los cuales permiten analizar interacciones entre especies y dinámicas complejas dentro de los ecosistemas.
...
\end{equation}
donde $a,b,c$ y $d$ son constantes positivas que representan las interacciones entre la presa y el depredador.
\begin{enumerate}
